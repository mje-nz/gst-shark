...
void do_print_proctime_event (event_id id, const gchar * bin_name, gchar * elementname, guint64 time);
void do_print_framerate_event (event_id id, const gchar * bin_name, gchar * elementname, guint64 fps);
void do_print_interlatency_event (event_id id,
    const gchar * from_bin, char *originpad, const gchar * to_bin, gchar * destinationpad, guint64 time);
void do_print_scheduling_event (event_id id, gchar * elementname, guint64 time);
void do_print_queue_level_event (event_id id, const gchar * bin_name, const gchar * elementname, guint32 bytes,
    guint32 max_bytes, guint32 buffers, guint32 max_buffers, guint64 time, guint64 max_time);
void do_print_bitrate_event (event_id id, const gchar * bin_name, gchar * elementname, guint64 bps);
void do_print_buffer_event (event_id id, const gchar * bin_name, const gchar * pad, GstClockTime pts,
